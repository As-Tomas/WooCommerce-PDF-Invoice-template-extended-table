...
<table class="order-details">
	<thead>
		<tr>
			...
			<th class="price-before-tax"><?php _e( 'Price (before tax)', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
			<th class="discount"><?php _e( 'Discount', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
			<th class="total-before-tax"><?php _e( 'Total (before tax)', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
			<th class="tax"><?php _e( 'Tax', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
			<th class="total_tax"><?php _e( 'Total tax', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
			<th class="total-eur"><?php _e( 'Total Eur', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php foreach ( $this->get_order_items() as $item_id => $item ) : ?>
			<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', 'item-'.$item_id, $this->get_type(), $this->order, $item_id ); ?>">
				...
				<td class="discount"><?php echo  $item['item']['line_subtotal'] - $item['item']['line_total']; ?></td>
				<td class="total-before-tax"><?php echo $item['line_total']; ?></td>
				<td class="tax"><?php echo $item['tax_rates']; ?></td>
				<td class="total_tax"><?php	echo  $item['item']['total_tax'] * $item['quantity']; ?></td>
